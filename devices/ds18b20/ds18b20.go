...
func (d *Dev) Temperature() (physic.Celsius, error) {
...
func (d *Dev) LastTemp() (physic.Celsius, error) {
	...
	// extension multiply by 1000 to get physic.Millis, divide by 16 due to 4
	// fractional bits. Datasheet p.4.
	c := (physic.Celsius(int8(spad[1]))<<8 + physic.Celsius(spad[0])) * 1000 / 16
