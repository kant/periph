...
type FFCMode struct {
	...
	DesiredFFCTempDelta     physic.Celsius          // Default: 3°C
...
func (d *Dev) GetTemp() (physic.Celsius, error) {
...
func (d *Dev) GetTempHousing() (physic.Celsius, error) {
	var v internal.CentiK
...
func (d *Dev) GetFFCModeControl() (*FFCMode, error) {
	...
	return &FFCMode{
		...
		DesiredFFCTempDelta:     physic.Celsius(v.DesiredFFCTempDelta * 10),
